...
VALUES
    ...
    (10, 'Final Destination', 'Andando pelas ruas agora destruídas de Nova York você se vê de frente com a maior e mais poderosa aberração que você já viu depois da sua sogra, é o momento de mostrar sua coragem e heroismo nessa batalha.', 0, 0, 0, 0),
    ...
    (12, 'Beco sem saída', 'Parece ser só um beco, tudo nesse lugar faz com que calafrios passem por sua espinha, você pode voltar pela ENTRADA LESTE.', 0, 13, 0, 0),
    (13, 'Porta sinistra do esgoto 2', 'Depois que a porta foi aberta novos horrores o aguardam, pelo menos o cheiro de ectoplasma, fezes e xixi estão quase no fim, você consegue ouvir grunidos fantasmagóricos e gritos vindo da ENTRADA SUL, a PORTA SINISTRA DO ESGOTO pode ser encontrada na ENTRADA NORTE e um corredor na ENTRADA OESTE, parece que o cheiro não vai passar por ali.', 5, 0, 14, 12),
    (14, 'Ruas de Nova York 1', 'Você sai dos esgotos seguindo os gritos de Novayorkinos, que palavra inventada, e segue até as ruas de Nova York onde você pode ver nuvens verdes se formando pela ENTRADA LESTE, pela ENTRADA NORTE você pode voltar para os esgotos COMO UM COVARDE.', 13, 15, 0, 0),
    (15, 'Ruas de Nova York 2', 'Seguindo as núvens você pode ver uma enorme silhueta de um ser se formando no horizonte, a paisagem que antes era cheia dos maiores prédios da cidade foi substituída por um enorme ser astral com formato arredondado e várias dobras em seu corpo como um imenso marshmallow, o momento da sua batalha final se encontra na ENTRADA NORTE, boa sorte.', 10, 0, 0, 14);
